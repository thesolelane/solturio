    ...
    <div className="container max-w-4xl mx-auto py-8 px-4">
      <Card className="border-destructive">
          ...
          <div className="space-y-4">
            <div className="flex gap-4 p-4 border border-primary/20 rounded-lg bg-primary/5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Your xxx.solturio.sol wallet holds{" "}
                  <span className="font-bold">certificates and legal documents</span>, not financial
                  assets. If you lose access, Solturio offers a{" "}
                  <span className="font-bold text-primary">$100 recovery service</span> with
                  identity verification (Replit, GitHub, or Google auth). Recovery takes 24-48
                  hours.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-4 border border-amber-600/20 rounded-lg bg-amber-600/5">
              ...
              <div className="space-y-2">
                <h3 className="font-semibold text-lg text-amber-600">
                  Save Your Recovery Phrase Anyway
                </h3>
                <p className="text-sm text-muted-foreground">
                  While recovery is available,{" "}
                  <span className="font-bold">
                    writing down your 12-word phrase is FREE and instant
                  </span>
                  . The recovery service is for emergencies only. Save yourself $100 and 2 days by
            ...
            <div className="flex gap-4 p-4 border border-destructive/20 rounded-lg bg-destructive/5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  You will receive a <span className="font-bold">12-word recovery phrase</span> that
                  you must write down on paper (no screenshots allowed). This phrase is the{" "}
                  <span className="font-bold">best way</span> to recover your wallet instantly and
                  for free. Keep it safe, keep it secret, and keep it offline.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-4 border border-amber-600/20 rounded-lg bg-amber-600/5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Your xxx.solturio.sol wallet is <span className="font-bold">restricted</span>. It
                  will automatically reject or burn any SPL tokens sent to it. This wallet ONLY
                  accepts Solturio-generated certificates, smart contracts, and IPFS metadata
                  hashes.
                </p>
              </div>
            </div>
          ...
          <div className="pt-6 border-t">
            <div className="flex items-start gap-3">
              ...
              >
                ...
                I will <span className="font-bold">write down my 12-word recovery phrase</span> to
                avoid paying the $100 recovery fee. I acknowledge that my wallet is restricted and
                will reject all SPL tokens and financial assets.
              </label>
            </div>
          </div>
        </CardContent>
        ...
        <CardFooter className="flex gap-3 justify-between">
          <Button variant="outline" onClick={handleCancel} data-testid="button-cancel-ceremony">
            Cancel Setup
          </Button>
          <Button
