      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Register official places where your logos are being used (website headers, social media profiles, etc.)
            This helps establish authorized usage for IP protection.
          </p>
        </div>
                        ...
                        <CardContent className="p-6">
                          ...
                          <div className="space-y-2 mb-4">
                            <div className="flex items-center gap-2 text-sm">
                              ...
                              <span className="font-medium">{getUsageTypeLabel(usage.usageType)}</span>
                            </div>
                            <div className="flex items-center gap-2 text-sm">
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button
                              ...
                              variant="destructive"
                              onClick={() => {
                                if (confirm("Are you sure you want to remove this authorized usage?")) {
