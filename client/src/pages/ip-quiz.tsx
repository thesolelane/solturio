          ...
          <CardContent className="space-y-4">
            ...
            {!showAnswer && (
              <div className="space-y-2">
                ...
                <Button 
                  ...
                  disabled={!isTimerActive || !userAnswer.trim() || submitAnswerMutation.isPending}
                  className="w-full"
                >
                  Submit Answer
                </Button>
            ...
            {showAnswer && (
              <div className="space-y-4">
                <Alert className={userAnswer.toLowerCase().trim() === currentQuestion.answer.toLowerCase().trim() 
