...
if (!ENCRYPTION_KEY || ENCRYPTION_KEY.length < 32) {
  console.error("CRITICAL: WALLET_ENCRYPTION_KEY or SESSION_SECRET must be set and at least 32 characters");
  console.error("For development, SESSION_SECRET should be sufficient. For production, set a dedicated WALLET_ENCRYPTION_KEY.");
